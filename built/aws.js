...
exports.async_uploadPhoto = void 0;
...
var async_uploadPhoto = function (file, userId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                objectName = "".concat(userId, "-").concat(Date.now(), "-").concat(filename);
...
exports.async_uploadPhoto = async_uploadPhoto;
